...
{
    public partial class AgregarArticulosOrdenDeCompra : Form
    {
        public AgregarArticulosOrdenDeCompra()
        {
            InitializeComponent();
        ...
        private void AgregarArticulosOrdenDeCompra_Load(object sender, EventArgs e)
        {
            CargarDatos();
        ...
        private void AgregarBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                int Subtotal = int.Parse(CantidadTxt.Text) * int.Parse(PrecioUnitarioTxt.Text);
                Conn.Open();
                SqlCommand query = new SqlCommand("INSERT INTO ArticulosOrdenDeCompra (Producto, Especificaciones, Cantidad, PrecioUnitario, Subtotal) values (@Producto, @Especificaciones, @Cantidad, @PrecioUnitario, @Subtotal)", Conn);
                ...
                query.Parameters.AddWithValue("@Subtotal", Subtotal);
        ...
        private void ProducntoCbo_SelectedIndexChanged(object sender, EventArgs e)
        {
