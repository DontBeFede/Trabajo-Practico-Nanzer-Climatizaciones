...
{
    public partial class AñadirArticulosFactura : Form
    {
        public AñadirArticulosFactura()
        {
            InitializeComponent();
        ...
        private void AñadirArticulosFactura_Load(object sender, EventArgs e)
        {
            CargarDatos();
        ...
        private void AgregarBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Conn.Open();
                SqlCommand query = new SqlCommand("INSERT INTO ArticulosFactura (Producto, Especificaciones, Cantidad, PrecioUnitario, Subtotal) values (@Producto, @Especificaciones, @Cantidad, @PrecioUnitario, @Subtotal)", Conn);
